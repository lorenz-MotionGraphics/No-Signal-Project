...
using UnityEngine;
using TMPro; // Essential for TMP_Text

public class TriplePressurePlateTMPmod : MonoBehaviour
{
    ...
    [Tooltip("Accepts both TextMeshPro (3D) and TextMeshProUGUI (UI Canvas) components.")]
    public TMP_Text textCounterDisplay; // <-- Changed from TextMeshPro to TMP_Text
